...
\item Team body's spiderman I will try to figure out how to Texture or draw as the dancing stage.
\item Need figure out thow to dance with time changes, or how to move according to keytype input.
\end{itemize}
...
\includegraphics[width=.9\linewidth]{./pic/Screen_Shot_2016-05-26_at_5_59_13_PM.png}
