...
\label{sec-1}
\begin{itemize}
\item Finished a surface rendering my team buddy's spiderman as the dancing stage. So far consider texture done, will need work on zombie movements a little bit with all the time left before Wednesday night's demo.
\item Todos: 
\begin{itemize}
