...
;            (gl-color 1 1 0) (gl-rect -1 -1 1 1)            
            (gl-pop-matrix))
...
(module+ main
  (define f (new frame%
                 (label "Hello World, I am a Zombie~~!!!")
                 (min-width 400)
                 (min-height 800)
