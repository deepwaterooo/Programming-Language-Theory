...
* Introduction
- Spiderman texturing: debugging. 
- Todos: 
  - Rendering my team buddy's spiderman as dancing stage, debugging. I guess I will have to manually normalize my cubes' vertex data in order to make the textures work. 
